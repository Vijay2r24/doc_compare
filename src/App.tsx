      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {leftDocument && rightDocument && viewMode === 'preview' && (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">View your documents with original formatting preserved</p>
            </div>
        ...
        {((leftDocument && !rightDocument) || (!leftDocument && rightDocument)) && (
          <div className="space-y-6">
            <div className="text-center">
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Document Preview</h3>
              <p className="text-gray-600">Upload another document to enable comparison</p>
            </div>
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Upload two Word documents to compare them side by side and see exactly what changed.
              </p>
